...
public class TimestampArrayFilter extends Filter<LocalDateTime> {

    public TimestampArrayFilter(String fieldName, QueryOperator queryOperator, LocalDateTime value) {
